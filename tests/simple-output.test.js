...
describe("testing simple-output programs", () => {
  ...
  files.forEach(f => {
    test(`${f}`, () => {
      ...
      const compileProcess = cp.spawnSync("node", ["./build/pyret.jarr", "--builtin-js-dir", "src/runtime", "--runtime-path", "../../src/runtime", "--compiled-dir", "tests/compiled", f]);
