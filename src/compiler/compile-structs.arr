...
minimal-globals = globals(runtime-builtins, runtime-types)
standard-builtins = compile-env(globals([string-dict:], runtime-types), [string-dict: "builtin(global)", runtime-provides])
